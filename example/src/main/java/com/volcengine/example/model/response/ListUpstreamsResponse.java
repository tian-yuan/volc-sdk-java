...
@Data
public class ListUpstreamsResponse {
    @JSONField(name = "ResponseMetadata")
    ResponseMetadata responseMetadata;
    @JSONField(name = "Result")
    ListUpstreamsResponse.ResultBean result;

    @Data
    public static class ResultBean {
        @JSONField(name = "Items")
        List<UpstreamItem> items;
        @JSONField(name = "Total")
        int total;
    }

    @Data
    public static class UpstreamItem {
        @JSONField(name = "Id")
        String id;
        @JSONField(name = "Name")
        String name;
        ...
        ListUpstreamsResponse.UpstreamSpec upstreamSpec;
        @JSONField(name = "LoadBalancerSettings")
        ListUpstreamsResponse.LoadBalancerSettings loadBalancerSettings;
        @JSONField(name = "CircuitBreakingSettings")
        ListUpstreamsResponse.CircuitBreakingSettings circuitBreakingSettings;
